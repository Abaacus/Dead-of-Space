...
public class Star : MonoBehaviour   // controlls the star the planet orbits around (surprise! the star moves, not the planet)
{
    ...
    private void Start()
    {
        ...
        gb = new GravityBody(rb);   // creates a new gravity body
